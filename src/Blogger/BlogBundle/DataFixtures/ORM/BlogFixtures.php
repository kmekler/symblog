...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    {
        $blog1 = new Blog();
        $blog1->setTitle('2A day with Symfony2');
        ...
        $blog2 = new Blog();
        $blog2->setTitle('2The pool on the roof must have a leak');
        ...
        $blog3 = new Blog();
        $blog3->setTitle('2Misdirection. What the eyes see and the ears hear, the mind believes');
        ...
        $blog4 = new Blog();
        $blog4->setTitle('2The grid - A digital frontier');
        ...
        $blog5 = new Blog();
        $blog5->setTitle('2You\'re either a one or a zero. Alive or dead');
